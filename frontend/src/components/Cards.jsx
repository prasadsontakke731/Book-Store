...
function Cards({ item }) {
    return (
        <div className='mt-4 my-3 p-3 '>
            <div className="card  bg-base-100 shadow-xl cursor-pointer hover:scale-105 duration-200 transition-all ease-in-out dark:bg-slate-900 dark:border dark:text-white ">
